...
namespace JohBloch.ConfluentKafka.SchemaRegistryExtClient.Tests
{
    ...
    public class CustomSubjectStrategyTests
    {
        ...
        public void CustomStrategy_IsUsedWhenProvided()
        {
            ...
            var client = new JohBloch.ConfluentKafka.SchemaRegistryExtClient.Services.SchemaRegistryExtClient(new Confluent.SchemaRegistry.SchemaRegistryConfig { Url = "http://localhost" }, null, null, options);
